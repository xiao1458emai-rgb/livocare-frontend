  ...
  "ar": {
    "translation": {
      ...
      "mood": {
        ...
        "needMoreData": "سجل {{remaining}} يوم إضافي للحصول على تحليلات دقيقة",
        "addFirst": "أضف مزاجك الأول"
      },
      ...
      "sleep": {
        ...
        "success": { "message": "✅ تم تسجيل جلسة النوم بنجاح!" },
        "errorMessages": {
        ...
        "recommendations": {
          "sleepMore": {
            ...
            "tips": { "bedtime": "⏱️ نم قبل 11 مساءً", "noScreens": "📱 ابتعد عن الشاشات قبل النوم بساعة", "darkRoom": "🌡️ حافظ على غرفة مظلمة وباردة", "meditate": "🧘 مارس التأمل 10 دقائق" }
          },
          "moveMore": {
            ...
            "why": "لماذا؟",
            "how": "كيف؟",
            "reasons": { "exercise": "الرياضة تزيد إفراز هرمونات النوم", "stress": "تقلل التوتر والقلق", "deepSleep": "تحسن جودة النوم العميق" },
            "tips": { "walk": "🚶‍♂️ امشِ 30 دقيقة يومياً", "yoga": "🧘 جرب اليوجا قبل النوم", "morning": "🌅 تمرن صباحاً لنتائج أفضل" }
          }
        }
      },
      ...
      "nutrition": {
        ...
        "mealsLoggedCount": "{{count}} وجبة مسجلة",
        "addMeal": "🥗 إضافة وجبة",
        "trackYourDiet": "تتبع تغذيتك",
        "dailyIntake": "📊 المدخول اليومي",
        "mealSummary": "📊 ملخص الوجبة",
        "caloriesShort": "السعرات الحرارية",
        "proteinShort": "البروتين",
        "carbsShort": "الكربوهيدرات",
        "fatShort": "الدهون",
        ...
        "unitLabel": "📏 الوحدة",
        "gram": "غرام",
        "addIngredientButton": "➕ إضافة مكون",
        "notesLabel": "ملاحظات",
        "saveMealButton": "💾 حفظ",
        "recentMeals": "📋 الوجبات الأخيرة",
        "noRecentMeals": "لا توجد وجبات حديثة",
        "mealDeleteConfirm": "هل أنت متأكد من حذف هذه الوجبة؟",
        "mealDeleteSuccess": "✅ تم حذف الوجبة بنجاح",
        "advancedStats": "📈 📊 إحصائيات تغذوية متقدمة",
        "totalMealsCount": "🍽️ {{count}} وجبة",
        "totalCaloriesCount": "🔥 {{count}} السعرات الحرارية",
        "totalProteinCount": "💪 {{count}}g البروتين",
        "weeklyLossExpected": "📉 خسارة متوقعة {{weight}} كجم أسبوعياً",
        "caloriesProgress": "🔥 السعرات الحرارية {{percent}}%",
        "caloriesProgressDetail": "{{current}}سعرة / {{target}}سعرة",
        "proteinProgress": "💪 البروتين {{percent}}%",
        "proteinProgressDetail": "{{current}}g / {{target}}g",
        "breakfastPercent": "🍳 فطور {{percent}}%",
        "lunchPercent": "🍲 غداء {{percent}}%",
        "dinnerPercent": "🍽️ عشاء {{percent}}%",
        "snackPercent": "🍎 وجبة خفيفة {{percent}}%",
        "viewMealDetails": "عرض تفاصيل الوجبة",
        "increaseProtein": "💪 زد من تناول البروتين (دجاج، بيض، بقوليات)",
        "recommendations": {
        ...
        "tabs": { "basic": "أساسي", "advanced": "متقدم", "patterns": "أنماط", "recommendations": "توصيات", "prediction": "تنبؤات" },
        "loading": { "advanced": "جاري تحميل التحليلات المتقدمة...", "patterns": "جاري تحميل الأنماط...", "recommendations": "جاري تحميل التوصيات...", "prediction": "جاري تحميل التنبؤات..." },
      ...
      "health": {
        "dashboard": {
          ...
          "status": { "normal": "طبيعي", "warning": "تحتاج مراجعة", "no_data": "لا توجد بيانات" },
          "weight": "الوزن",
        ...
        "form": {
          ...
          "systolicHint": "النطاق الطبيعي: 90-140 مم زئبق",
          "diastolicHint": "النطاق الطبيعي: 60-90 مم زئبق",
          ...
          "errors": {
            ...
            "heartRate": "يجب أن يكون النبض بين {{min}} و {{max}} نبضة في الدقيقة",
            "spo2": "يجب أن تكون نسبة الأكسجين بين {{min}} و {{max}}%",
            "mmHg": "مم زئبق"
          },
          "advice": {
      ...
      "history": {
        ...
        "bpNotMeasured": "لم يتم قياس الضغط",
        "glucoseNotMeasured": "لم يتم قياس السكر",
        "weightNotMeasured": "لم يتم قياس الوزن",
        "normalGlucose": "✅ طبيعي",
        "normalWeight": "✅ طبيعي",
        "page": "صفحة",
        "of": "من"
      ...
      "profile": {
        ...
        "tabs": { "profile": "الملف الشخصي", "goals": "الأهداف الصحية", "settings": "الإعدادات" },
        "profile": {
        ...
        "goals": {
          ...
          "days": "أيام",
          "dailyRate": "المعدل اليومي المطلوب",
          "perDay": "في اليوم",
          "onTrack": "على المسار الصحيح",
          "offTrack": "متأخر عن الهدف",
          "updateProgress": "تحديث التقدم",
          "habitAutoTrack": "يتم تتبع هذه العادة تلقائياً من نشاطك اليومي"
        },
        "smartProfile": { "title": "الملف الشخصي الذكي", "bmi": "مؤشر كتلة الجسم", "age": "العمر", "healthScore": "درجة الصحة", "recommendations": "توصيات مخصصة" },
        "bmi": { "underweight": "نقص وزن", "normal": "وزن طبيعي", "overweight": "زيادة وزن", "obese": "سمنة" },
        "recommendations": {
          "studentSleep": "كطالب، حاول النوم 7-8 ساعات لتحسين التركيز",
          "studentNutrition": "تناول وجبات متوازنة لدعم نشاطك الدراسي",
          "employeeActivity": "أضف 30 دقيقة مشي يومياً لتحسين صحتك",
          "employeeStress": "مارس تمارين التنفس العميق لتخفيف التوتر",
          "freelancerRoutine": "نظم وقتك بين العمل والراحة",
          "weightGain": "تحتاج لزيادة الوزن، ركز على الأطعمة الغنية بالسعرات",
          "weightLoss": "لخسارة الوزن، قلل السكريات وزد النشاط البدني",
          "sleepMore": "تحتاج {{hours}} ساعات نوم إضافية",
          "activityMore": "تحتاج {{minutes}} دقيقة نشاط إضافية أسبوعياً"
        },
        "password": {
        ...
        "units": { "kg": "كجم", "cm": "سم", "point": "نقطة", "minute": "دقيقة", "kilo": "كيلو", "hours": "ساعات", "calories": "سعرة" },
        "danger": {
          "zone": "منطقة الخطر",
        ...
        "achievedAuto": "🎉 تم تحقيق الهدف تلقائياً! أحسنت!"
      },
      ...
      "sidebar": {
        ...
        "extras": "إضافات",
        "reports": "📊 التقارير",
        "reportsDesc": "تقارير صحية وتحليلات",
        "tooltips": {
      ...
      "analytics": {
        ...
        "activity": {
          ...
          "recommendations": {
            ...
            "startActivity": { "title": "ابدأ نشاطك اليوم", "advice": "سجل أول نشاط رياضي لك اليوم", "basedOn": "لا توجد أنشطة مسجلة بعد", "tip1": "جرب المشي لمدة 10 دقائق", "tip2": "اختر نشاطاً تحبه", "tip3": "حدد وقتاً ثابتاً يومياً" },
            "increaseActivity": { "title": "زد نشاطك الأسبوعي", "advice": "تحتاج {{minutes}} دقيقة إضافية هذا الأسبوع", "basedOn": "لديك {{total}} دقيقة نشاط من أصل 150 دقيقة موصى بها", "tip1": "امشِ 15 دقيقة إضافية يومياً", "tip2": "استخدم الدرج بدلاً من المصعد", "tip3": "جرب تطبيقات تتبع النشاط" },
            "maintainActivity": { "title": "أداء ممتاز", "advice": "أنت تحقق المستوى الموصى به من النشاط", "basedOn": "{{total}} دقيقة نشاط هذا الأسبوع", "tip1": "نوّع في أنواع التمارين", "tip2": "أضف تمارين القوة مرتين أسبوعياً", "tip3": "شارك أصدقاءك في النشاط" },
  ...
  "days": {
    ...
    "saturday": "السبت"
        ...
        "nutrition": {
          ...
          "healthScore": { "title": "📊 درجة صحتك", "heartRate": "نبض القلب", "normal": "طبيعي", "sleep": "النوم", "nutrition": "التغذية", "mood": "المزاج", "stable": "مستقر", "activity": "النشاط", "active": "نشط" },
          "charts": {
          ...
          "recommendations": {
            ...
            "increaseProtein": {
              "title": "تحتاج بروتين أكثر",
              "advice": "أضف {{protein}}g بروتين يومياً",
              "reasons": ["البروتين ضروري لبناء العضلات", "يساعد على الشعور بالشبع لفترة أطول", "يُحسن التمثيل الغذائي"],
              "tips": ["🥚 بيضة = 6g بروتين", "🍗 صدر دجاج (100g) = 31g بروتين", "🥛 كوب حليب = 8g بروتين", "🫘 كوب عدس = 18g بروتين"]
            },
            "avoidLateMeals": {
              "title": "تجنب الأكل المتأخر",
              "advice": "توقف عن الأكل بعد الساعة 10 مساءً",
              "reasons": ["الأكل المتأخر يضر بجودة النوم", "يسبب زيادة في تخزين الدهون", "يؤثر على هرمونات الجوع"],
              "tips": ["⏰ حدد وقتاً نهائياً للأكل", "🌿 اشرب شاي أعشاب بدلاً من الطعام", "🍎 إذا جعت، كل تفاحة أو خضار"]
            },
            "eatBreakfast": {
              "title": "لا تفوت الإفطار",
              "advice": "تناول وجبة إفطار متوازنة",
              "reasons": ["الإفطار يحسن التمثيل الغذائي", "يزيد التركيز والطاقة صباحاً", "يساعد على التحكم بالوزن"],
              "tips": ["🥣 شوفان مع فواكه = إفطار مثالي", "🍳 بيض مع خبز أسمر = بروتين وطاقة", "🥑 توست مع أفوكادو = دهون صحية"]
            },
      ...
      "notifications": {
        ...
        "types": { "health": "صحي", "nutrition": "تغذوي", "sleep": "نوم", "mood": "مزاج", "habit": "عادة", "alert": "تنبيه", "reminder": "تذكير", "achievement": "إنجاز", "tip": "نصيحة", "activity": "النشاط البدني" },
        "statsData": { "total": "الإجمالي", "unread": "غير مقروء", "read": "مقروء", "last7Days": "آخر 7 أيام" }
      },
      ...
      "smartDashboard": {
        ...
        "healthScore": { "title": "درجة صحتك الشخصية", "footer": "حافظ على عاداتك الصحية لتحسين درجتك" },
        "foodSearch": { "title": "بحث الطعام" },
        "correlations": {
      ...
      "smartRecommendations": {
        ...
        "noRecommendations": { "title": "✨ كل شيء على ما يرام!", "subtitle": "لا توجد توصيات خاصة حالياً" },
        "health": {
          "weightHigh": {
            "title": "وزنك يحتاج عناية",
            "message": "مؤشر كتلة جسمك {{bmi}} (زيادة وزن)",
            "advice": "ركز على الأكل الصحي وزد نشاطك",
            "actions": ["🥗 قلل السكريات والنشويات", "🚶 امشِ 30 دقيقة يومياً", "💧 اشرب 8 أكواب ماء", "🥩 زد البروتين في وجباتك"],
          ...
          "weightLow": {
            ...
            "actions": ["🥑 أضف دهون صحية لوجباتك", "🥜 تناول المكسرات والفواكه المجففة", "🍚 زد كمية الأرز والمكرونة", "🥛 اشرب حليب كامل الدسم"],
            "basedOn": "تحليل الوزن والطول"
          },
          "bpHigh": {
            "title": "ضغطك مرتفع قليلاً",
            "advice": "تابع ضغطك بانتظام",
            "actions": ["🧂 قلل الملح في الطعام", "🚭 ابتعد عن المنبهات", "🧘 مارس التأمل يومياً", "🥗 كل موز وأفوكادو"],
            "basedOn": "آخر قياس للضغط"
          },
          "glucoseHigh": {
            "title": "سكر الدم مرتفع",
            "advice": "راقب مستوى السكر",
            "actions": ["🍬 قلل السكريات البسيطة", "🥗 زد الألياف في وجباتك", "🚶 امشِ بعد الأكل", "⏰ لا تؤجل الوجبات"],
            "basedOn": "آخر قياس للسكر"
          },
          "glucoseLow": {
            "title": "سكر الدم منخفض",
            "advice": "تناول وجبة خفيفة",
            "actions": ["🍌 كل موزة أو تمر", "🥤 اشرب عصير فواكه", "🍪 تناول قطعة صغيرة من الحلويات", "⏰ لا تتأخر في وجباتك"],
            "basedOn": "آخر قياس للسكر"
          }
        },
        "nutrition": {
          "breakfast": {
            ...
            "actions": ["🥚 بيض مع خبز أسمر = بروتين + طاقة", "🥣 شوفان مع فواكه = ألياف + فيتامينات", "🥑 توست مع أفوكادو = دهون صحية", "☕ قهوة أو شاي أخضر = منبه طبيعي"],
          ...
          "lunch": {
            ...
            "actions": ["🍗 صدر دجاج أو سمك = بروتين", "🥗 سلطة خضراء = ألياف وفيتامينات", "🍚 أرز أو برغل = كربوهيدرات", "🥣 شوربة = ترطيب + دفء"],
          ...
          "dinner": {
            ...
            "actions": ["🥗 زبادي مع خيار = سهل الهضم", "🍎 تفاح أو فاكهة = سكريات طبيعية", "🥛 كوب حليب دافئ = يساعد على النوم", "🌿 شاي أعشاب = مهدئ طبيعي"],
          ...
          "season": {
            "winter": {
              ...
              "actions": ["🥣 شوربة عدس أو خضار يومياً", "🍯 زنجبيل مع عسل = مناعة", "🍠 بطاطا حلوة مشوية = طاقة", "☕ مشروبات ساخنة = تدفئة"],
              "basedOn": "فصل الشتاء"
            },
            "summer": {
              "title": "🥤 ترطيب الصيف",
              ...
              "actions": ["💧 اشرب 10 أكواب ماء يومياً", "🍉 بطيخ وخيار = ترطيب طبيعي", "🥗 سلطات منعشة = فيتامينات", "🧃 عصائر طبيعية بدون سكر"],
              "basedOn": "فصل الصيف"
            }
          }
        },
        "sleep": {
          "bedtime": {
            ...
            "actions": ["📱 ابتعد عن الشاشات قبل النوم بساعة", "🌡️ اجعل غرفتك مظلمة وباردة", "🧘 مارس التنفس العميق 5 دقائق", "📝 دوّن أفكار الغد"],
          ...
          "sleepMore": {
            ...
            "actions": ["⏰ نم قبل 11 مساءً", "🚫 تجنب الكافيين بعد العصر", "🌙 خفف الأضواء مساءً", "🎵 استمع لأصوات مريحة"],
          ...
          "quality": {
            ...
            "actions": ["🛏️ استخدم فراش مريح", "🌡️ درجة حرارة الغرفة 20-22 درجة", "🚫 لا تأكل قبل النوم بساعتين", "🧘 جرب التأمل قبل النوم"],
        ...
        "mood": {
          "low": {
            ...
            "actions": ["🚶 اخرج للمشي في الطبيعة", "🎵 استمع لموسيقى تحبها", "📞 اتصل بصديق مقرب", "🧘 مارس التأمل 10 دقائق"],
          ...
          "weather": {
            "rainy": {
              ...
              "actions": ["☕ اشرب مشروبك المفضل", "📖 اقرأ كتاباً ممتعاً", "🎬 شاهد فيلماً كوميدياً", "🧘 تأمل واستمع للمطر"],
            ...
            "sunny": {
              ...
              "actions": ["🚶 امشِ 20 دقيقة في الشمس", "🌿 اجلس في الهواء الطلق", "🏃‍♂️ مارس رياضة خارجية", "🌱 اهتم بزراعة النباتات"],
        ...
        "habits": {
          ...
          "medicine": {
            ...
            "actions": ["💧 اشرب ماء مع الدواء", "⏰ سجل أنك تناولته", "📱 ضع تذكير للجرعة القادمة"],
        ...
        "activity": {
          "more": {
            ...
            "actions": ["🚶 امشِ 20 دقيقة يومياً", "🧘 جرب تمارين منزلية", "🚴 استخدم الدراجة للتنقل", "👥 تمرن مع صديق"],
          ...
          "weather": {
            "hot": {
              ...
              "actions": ["🏊 سباحة = أفضل نشاط في الحر", "🌅 تمرن الصباح الباكر أو المساء", "💧 اشرب ماء أكثر أثناء الرياضة", "🏠 جرب تمارين داخلية"],
              "basedOn": "درجة الحرارة الحالية"
            },
            "cold": {
              "title": "جو بارد",
              "advice": "تمرن بحذر",
              "actions": ["🧥 ارتدِ ملابس دافئة", "🏃 إحماء جيد قبل الرياضة", "🏠 تمارين داخلية مناسبة", "☕ اشرب دافئاً بعد الرياضة"],
              "basedOn": "درجة الحرارة الحالية"
            }
          }
        },
        "routine": {
          "morning": {
            ...
            "actions": ["☀️ تعرض لضوء الشمس 10 دقائق", "💧 اشرب كوب ماء دافئ مع ليمون", "🧘 تمارين تمدد خفيفة", "📝 خطط ليومك"],
          ...
          "night": {
            ...
            "actions": ["📵 ابتعد عن الشاشات", "📖 اقرأ كتاباً ورقيًا", "🌿 اشرب شاي أعشاب", "🧘 تأمل 5 دقائق"],
      ...
      "reports": {
        ...
        "healthScoreValue": "{{score}}/100",
        "healthScoreGrade": "{{grade}}",
        "story": {
          "title": "📖 القصة الذكية لصحبتك",
          "sleepVeryLow": "🔴 🌙 تنام فقط {{hours}} ساعات - هذا قليل جداً",
          "nutritionWarning": "⚠️ 🥗 تتناول {{calories}} سعرة - حاول تحسين نظامك الغذائي",
          "bpNormal": "📈 ❤️ ضغط دمك طبيعي ({{systolic}}/{{diastolic}})",
          "activityLow": "⚠️ 🏃 تمارس الرياضة {{minutes}} دقيقة فقط - زد نشاطك",
          "moodGood": "⚠️ 😊 مزاجك {{mood}}/5 - يمكن تحسينه"
        },
        "topRecommendation": {
          "title": "🌙 التوصية الأولى",
          "name": "reports.recommendations.sleepMore.title",
          "advice": "reports.recommendations.sleepMore.advice",
          "action": "💡 reports.recommendations.sleepMore.action"
        },
        "tabs": {
          "summary": "📊 الملخص",
          "sleep": "🌙 النوم",
          ...
          "habits": "💊 العادات",
          "activity": "🏃 النشاط البدني",
          "health": "❤️ القياسات الحيوية"
        },
        "types": { "weekly": "تقرير أسبوعي", "monthly": "تقرير شهري", "yearly": "تقرير سنوي", "custom": "تقرير مخصص" },
        "export": { "pdfComingSoon": "سيتم إضافة ميزة تصدير PDF قريباً", "csvComingSoon": "سيتم إضافة ميزة تصدير CSV قريباً" },
        "summary": {
          "title": "ملخص الفترة",
        ...
        "health": {
          "title": "❤️ القياسات الحيوية",
          "weight": "الوزن",
          "weightValue": "{{weight}} كجم",
          "bloodPressure": "ضغط الدم",
          "bloodPressureValue": "{{systolic}}/{{diastolic}} mmHg",
          "glucose": "السكر",
          "glucoseValue": "{{glucose}} mg/dL",
          "readingsCount": "عدد القراءات",
          "readingsValue": "{{count}} قراءة",
        ...
        "sleep": {
          ...
          "avgHours": "متوسط النوم",
          "hoursUnit": "ساعة",
          "totalNights": "عدد الليالي",
        ...
        "activity": {
          ...
          "totalMinutes": "إجمالي الدقائق",
          "totalMinutesValue": "{{minutes}} دقيقة",
          "avgMinutes": "متوسط الدقائق/يوم",
          "avgMinutesValue": "{{minutes}} دقيقة/يوم",
          "records": "عدد الأنشطة",
          "recordsCount": "{{count}} نشاط",
        ...
        "records": "عدد التسجيلات",
        "quarterly": "ربع سنوي",
        "sleepData": { "title": "النوم", "details": "تفاصيل النوم", "avgHours": "متوسط ساعات النوم", "totalNights": "عدد الليالي المسجلة", "hours": "ساعات" },
        "nutritionData": { "title": "التغذية", "details": "تفاصيل التغذية", "avgCalories": "متوسط السعرات اليومية", "avgProtein": "متوسط البروتين", "totalMeals": "إجمالي الوجبات" },
        "activityData": { "title": "النشاط البدني", "details": "تفاصيل النشاط", "totalMinutes": "إجمالي دقائق النشاط", "avgMinutes": "متوسط النشاط اليومي", "records": "عدد الأنشطة", "minutes": "دقيقة", "perDay": "في اليوم" },
        "moodData": { "title": "المزاج", "details": "تفاصيل المزاج", "avgScore": "متوسط درجة المزاج", "totalDays": "عدد الأيام المسجلة" },
        "habitsData": { "title": "العادات", "details": "تفاصيل العادات", "completionRate": "نسبة الالتزام", "completed": "العادات المنجزة" },
        "recommendationsList": {
          "start": { "title": "ابدأ بتسجيل بياناتك", "advice": "كلما سجلت المزيد من البيانات، حصلت على توصيات أكثر دقة", "action": "سجل أول قراءة صحية اليوم" },
          "sleepMore": { "title": "حسّن نومك", "advice": "تنام في المتوسط {{hours}} ساعة فقط", "action": "حاول النوم 7-8 ساعات يومياً لتحسين صحتك" },
          "increaseCalories": { "title": "زد سعراتك", "advice": "تتناول {{calories}} سعرة فقط في اليوم", "action": "أضف وجبات صحية غنية بالبروتين" },
          "decreaseCalories": { "title": "قلل سعراتك", "advice": "تتناول {{calories}} سعرة في اليوم", "action": "ركز على الخضروات والبروتين وقلل الكربوهيدرات" },
          "increaseActivity": { "title": "زد نشاطك", "advice": "تمارس الرياضة {{minutes}} دقيقة فقط يومياً", "action": "المشي 30 دقيقة يومياً يحسن صحتك بشكل كبير" },
          "improveMood": { "title": "حسّن مزاجك", "advice": "مزاجك في المتوسط {{mood}}/5", "action": "جرب التأمل أو تمارين التنفس العميق" },
          "improveHabits": { "title": "التزم بعاداتك", "advice": "تلتزم بعاداتك بنسبة {{rate}}% فقط", "action": "ابدأ بعادة صغيرة وسهلة التطبيق" },
          "excellent": { "title": "أحسنت!", "advice": "جميع مؤشراتك الصحية جيدة", "action": "استمر في هذا النمط الصحي الرائع" }
        }
      },
  ...
  "en": {
    "translation": {
      ...
      "mood": {
        ...
        "needMoreData": "Record {{remaining}} more days for accurate analysis",
        "addFirst": "Add your first mood"
      },
      "habits": {
      ...
      "sleep": {
        ...
        "notes": "Notes",
        "optional": "optional",
        "startTimeHelp": "use 24-hour format",
        ...
        "success": { "message": "✅ Sleep session logged successfully!" },
        "errorMessages": {
        ...
        "recommendations": {
          "sleepMore": {
            ...
            "tips": { "bedtime": "⏱️ Sleep before 11 PM", "noScreens": "📱 Avoid screens 1 hour before bed", "darkRoom": "🌡️ Keep your room dark and cool", "meditate": "🧘 Meditate for 10 minutes" }
          },
          "moveMore": {
            ...
            "why": "Why?",
            "how": "How?",
            "reasons": { "exercise": "Exercise increases sleep hormones", "stress": "Reduces stress and anxiety", "deepSleep": "Improves deep sleep quality" },
            "tips": { "walk": "🚶‍♂️ Walk 30 minutes daily", "yoga": "🧘 Try yoga before bed", "morning": "🌅 Exercise in the morning for best results" }
          }
        }
      },
      "nutrition": {
        ...
        "mealsLoggedCount": "{{count}} meals logged",
        "addMeal": "🥗 Add Meal",
        "trackYourDiet": "Track Your Diet",
        ...
        "mealDeleteConfirm": "Are you sure you want to delete this meal?",
        "mealDeleteSuccess": "✅ Meal deleted successfully",
        "advancedStats": "📈 📊 Advanced Nutrition Statistics",
        "totalMealsCount": "🍽️ {{count}} meals",
        "totalCaloriesCount": "🔥 {{count}} calories",
        "totalProteinCount": "💪 {{count}}g protein",
        "weeklyLossExpected": "📉 Expected loss {{weight}} kg per week",
        "caloriesProgress": "🔥 Calories {{percent}}%",
        "caloriesProgressDetail": "{{current}} cal / {{target}} cal",
        "proteinProgress": "💪 Protein {{percent}}%",
        "proteinProgressDetail": "{{current}}g / {{target}}g",
        "breakfastPercent": "🍳 Breakfast {{percent}}%",
        "lunchPercent": "🍲 Lunch {{percent}}%",
        "dinnerPercent": "🍽️ Dinner {{percent}}%",
        "snackPercent": "🍎 Snack {{percent}}%",
        "viewMealDetails": "View meal details",
        "increaseProtein": "💪 Increase protein intake (chicken, eggs, legumes)",
        "recommendations": {
        ...
        "tabs": { "basic": "Basic", "advanced": "Advanced", "patterns": "Patterns", "recommendations": "Recommendations", "prediction": "Predictions" },
        "loading": { "advanced": "Loading advanced analytics...", "patterns": "Loading patterns...", "recommendations": "Loading recommendations...", "prediction": "Loading predictions..." },
        ...
        "productNotFoundAddManually": "Product not found, please add nutritional values manually",
        "productAdded": "Product added successfully",
        "customProduct": "Custom product",
        "caloriesPer100g": "calories / 100g",
        "networkError": "Network error, please try again",
        "cameraPermissionError": "Please allow camera access",
        "barcodeNotSupported": "Your browser does not support barcode scanning, please use a modern browser",
        "tryAgain": "Try again"
      },
      "health": {
        "dashboard": {
        ...
        "form": {
          ...
          "errors": {
            ...
            "heartRate": "Heart rate should be between {{min}} and {{max}} BPM",
            "spo2": "Blood oxygen should be between {{min}} and {{max}}%",
            "mmHg": "mmHg"
          },
          "advice": {
      ...
      "history": {
        ...
        "bpNotMeasured": "Not measured",
        "glucoseNotMeasured": "Not measured",
      ...
      "profile": {
        ...
        "goals": {
          ...
          "daysLeft": "Days Left",
          "days": "days",
          "dailyRate": "Daily Rate Needed",
          "perDay": "per day",
          "onTrack": "On Track",
          "offTrack": "Off Track",
          "updateProgress": "Update Progress",
          "habitAutoTrack": "This habit is automatically tracked from your daily activity"
        },
        "smartProfile": { "title": "Smart Profile", "bmi": "BMI", "age": "Age", "healthScore": "Health Score", "recommendations": "Personalized Recommendations" },
        "bmi": { "underweight": "Underweight", "normal": "Normal", "overweight": "Overweight", "obese": "Obese" },
        "recommendations": {
          "studentSleep": "As a student, try to sleep 7-8 hours to improve focus",
          "studentNutrition": "Eat balanced meals to support your studies",
          "employeeActivity": "Add 30 minutes of daily walking to improve your health",
          "employeeStress": "Practice deep breathing exercises to reduce stress",
          "freelancerRoutine": "Organize your time between work and rest",
          "weightGain": "Need to gain weight, focus on calorie-rich foods",
          "weightLoss": "To lose weight, reduce sugars and increase physical activity",
          "sleepMore": "You need {{hours}} more hours of sleep",
          "activityMore": "You need {{minutes}} more minutes of activity per week"
        },
        "password": {
        ...
        "units": { "kg": "kg", "cm": "cm", "point": "point", "minute": "minute", "kilo": "kilo", "hours": "hours", "calories": "calories" },
        "danger": {
          "zone": "Danger Zone",
        ...
        "achievedAuto": "🎉 Goal automatically achieved! Well done!"
      },
      "dashboard": {
      ...
      "health_insights": {
        ...
        "vital_signs": {
          ...
          "insights": "Insights",
          "alerts": "Alerts",
          "weight_low": { "message": "⚠️ Your weight is very low", "details": "{weight} kg below normal range", "recommendation": "You need to increase calories and protein" },
      ...
      "analytics": {
        ...
        "activity": {
          ...
          "bestActivity": "🏋️ Your Favorite Activity",
          "factors": {
          ...
          "recommendations": {
            ...
            "startActivity": { "title": "Start Your Daily Activity", "advice": "Log your first physical activity today", "basedOn": "No activities recorded yet", "tip1": "Try walking for 10 minutes", "tip2": "Choose an activity you enjoy", "tip3": "Set a fixed daily time" },
            "increaseActivity": { "title": "Increase Your Weekly Activity", "advice": "You need {{minutes}} more minutes this week", "basedOn": "You have {{total}} minutes of activity out of the recommended 150 minutes", "tip1": "Walk an extra 15 minutes daily", "tip2": "Use stairs instead of elevator", "tip3": "Try activity tracking apps" },
            "maintainActivity": { "title": "Excellent Performance", "advice": "You're achieving the recommended activity level", "basedOn": "{{total}} minutes of activity this week", "tip1": "Vary your exercise types", "tip2": "Add strength training twice a week", "tip3": "Share activities with friends" },
  ...
  "days": {
    ...
    "saturday": "Saturday"
      ...
      "notifications": {
        ...
        "types": { "health": "Health", "nutrition": "Nutrition", "sleep": "Sleep", "mood": "Mood", "habit": "Habit", "alert": "Alert", "reminder": "Reminder", "achievement": "Achievement", "tip": "Tip", "activity": "Physical Activity" },
        "statsData": { "total": "Total", "unread": "Unread", "read": "Read", "last7Days": "Last 7 Days" }
      },
      "smartDashboard": {
        ...
        "healthScore": { "title": "Your Health Score", "footer": "Maintain healthy habits to improve your score" },
      ...
      "smartRecommendations": {
        ...
        "noRecommendations": { "title": "✨ Everything looks great!", "subtitle": "No specific recommendations at the moment" },
        "health": {
          "weightHigh": {
            "title": "Your weight needs attention",
            "message": "Your BMI is {{bmi}} (overweight)",
            "advice": "Focus on healthy eating and increase activity",
            "actions": ["🥗 Reduce sugars and starches", "🚶 Walk 30 minutes daily", "💧 Drink 8 glasses of water", "🥩 Increase protein in your meals"],
          ...
          "weightLow": {
            ...
            "actions": ["🥑 Add healthy fats to meals", "🥜 Eat nuts and dried fruits", "🍚 Increase rice and pasta portions", "🥛 Drink whole milk"],
            "basedOn": "Weight and height analysis"
          },
          "bpHigh": {
            "title": "Your blood pressure is slightly high",
            "advice": "Monitor your pressure regularly",
            "actions": ["🧂 Reduce salt in food", "🚭 Avoid stimulants", "🧘 Meditate daily", "🥗 Eat bananas and avocados"],
            "basedOn": "Latest blood pressure reading"
          },
          "glucoseHigh": {
            "title": "Your blood sugar is high",
            "advice": "Monitor your sugar level",
            "actions": ["🍬 Reduce simple sugars", "🥗 Increase fiber in meals", "🚶 Walk after meals", "⏰ Don't skip meals"],
            "basedOn": "Latest glucose reading"
          },
          "glucoseLow": {
            "title": "Your blood sugar is low",
            "advice": "Have a light snack",
            "actions": ["🍌 Eat a banana or dates", "🥤 Drink fruit juice", "🍪 Have a small sweet treat", "⏰ Don't delay meals"],
            "basedOn": "Latest glucose reading"
          }
        },
        "nutrition": {
          "breakfast": {
            ...
            "actions": ["🥚 Eggs with whole wheat bread = protein + energy", "🥣 Oatmeal with fruits = fiber + vitamins", "🥑 Avocado toast = healthy fats", "☕ Coffee or green tea = natural stimulant"],
          ...
          "lunch": {
            ...
            "actions": ["🍗 Chicken breast or fish = protein", "🥗 Green salad = fiber and vitamins", "🍚 Rice or bulgur = carbohydrates", "🥣 Soup = hydration + warmth"],
          ...
          "dinner": {
            ...
            "actions": ["🥗 Yogurt with cucumber = easy to digest", "🍎 Apple or fruit = natural sugars", "🥛 Warm milk = helps sleep", "🌿 Herbal tea = natural relaxant"],
          ...
          "season": {
            "winter": {
              ...
              "actions": ["🥣 Lentil or vegetable soup daily", "🍯 Ginger with honey = immunity", "🍠 Baked sweet potato = energy", "☕ Hot drinks = warming"],
            ...
            "summer": {
              ...
              "actions": ["💧 Drink 10 glasses of water daily", "🍉 Watermelon and cucumber = natural hydration", "🥗 Fresh salads = vitamins", "🧃 Natural juices without sugar"],
        ...
        "sleep": {
          "bedtime": {
            ...
            "actions": ["📱 Avoid screens 1 hour before bed", "🌡️ Keep room dark and cool", "🧘 Deep breathing for 5 minutes", "📝 Write down tomorrow's thoughts"],
          ...
          "sleepMore": {
            ...
            "actions": ["⏰ Sleep before 11 PM", "🚫 Avoid caffeine after 4 PM", "🌙 Dim lights in the evening", "🎵 Listen to relaxing sounds"],
          ...
          "quality": {
            ...
            "actions": ["🛏️ Use comfortable bedding", "🌡️ Room temperature 68-72°F", "🚫 Don't eat 2 hours before bed", "🧘 Try meditation before sleep"],
        ...
        "mood": {
          "low": {
            ...
            "actions": ["🚶 Walk in nature", "🎵 Listen to music you love", "📞 Call a close friend", "🧘 Meditate for 10 minutes"],
          ...
          "weather": {
            "rainy": {
              ...
              "actions": ["☕ Have your favorite drink", "📖 Read an enjoyable book", "🎬 Watch a comedy movie", "🧘 Meditate and listen to rain"],
            ...
            "sunny": {
              ...
              "actions": ["🚶 Walk 20 minutes in the sun", "🌿 Sit outdoors", "🏃‍♂️ Exercise outside", "🌱 Take care of plants"],
        ...
        "habits": {
          ...
          "medicine": {
            ...
            "actions": ["💧 Drink water with medication", "⏰ Mark that you took it", "📱 Set reminder for next dose"],
        ...
        "activity": {
          "more": {
            ...
            "actions": ["🚶 Walk 20 minutes daily", "🧘 Try home exercises", "🚴 Use bike for transportation", "👥 Exercise with a friend"],
          ...
          "weather": {
            "hot": {
              ...
              "actions": ["🏊 Swimming = best activity in heat", "🌅 Exercise early morning or evening", "💧 Drink more water during exercise", "🏠 Try indoor exercises"],
              "basedOn": "Current temperature"
            },
            "cold": {
              "title": "Cold weather",
              "advice": "Exercise carefully",
              "actions": ["🧥 Wear warm clothes", "🏃 Warm up well before exercise", "🏠 Suitable indoor exercises", "☕ Drink warm after exercise"],
              "basedOn": "Current temperature"
            }
          }
        },
        "routine": {
          "morning": {
            ...
            "actions": ["☀️ Get sunlight for 10 minutes", "💧 Drink warm water with lemon", "🧘 Light stretching exercises", "📝 Plan your day"],
          ...
          "night": {
            ...
            "actions": ["📵 Stay away from screens", "📖 Read a physical book", "🌿 Drink herbal tea", "🧘 Meditate for 5 minutes"],
      ...
      "reports": {
        ...
        "story": {
          ...
          "nutritionWarning": "⚠️ 🥗 You consume {{calories}} calories - Try to improve your diet",
          "bpNormal": "📈 ❤️ Your blood pressure is normal ({{systolic}}/{{diastolic}})",
          "activityLow": "⚠️ 🏃 You only exercise {{minutes}} minutes - Increase your activity",
          "moodGood": "⚠️ 😊 Your mood is {{mood}}/5 - Can be improved"
        },
        "topRecommendation": {
        ...
        "tabs": {
          ...
          "habits": "💊 Habits",
          "activity": "🏃 Physical Activity",
          "health": "❤️ Vital Signs"
        },
        "types": { "weekly": "Weekly Report", "monthly": "Monthly Report", "yearly": "Yearly Report", "custom": "Custom Report" },
        "export": { "pdfComingSoon": "PDF export feature coming soon", "csvComingSoon": "CSV export feature coming soon" },
        "summary": {
        ...
        "activity": {
          ...
          "totalMinutes": "Total Minutes",
          "totalMinutesValue": "{{minutes}} minutes",
          "avgMinutes": "Average Minutes/Day",
          "avgMinutesValue": "{{minutes}} min/day",
          "records": "Activities Count",
          "recordsCount": "{{count}} activities",
        ...
        "records": "Records",
        "quarterly": "Quarterly",
        "sleepData": { "title": "Sleep", "details": "Sleep Details", "avgHours": "Average Sleep Hours", "totalNights": "Nights Recorded", "hours": "hours" },
        "nutritionData": { "title": "Nutrition", "details": "Nutrition Details", "avgCalories": "Average Daily Calories", "avgProtein": "Average Protein", "totalMeals": "Total Meals" },
        "activityData": { "title": "Physical Activity", "details": "Activity Details", "totalMinutes": "Total Activity Minutes", "avgMinutes": "Average Daily Activity", "records": "Activities Count", "minutes": "minutes", "perDay": "per day" },
        "moodData": { "title": "Mood", "details": "Mood Details", "avgScore": "Average Mood Score", "totalDays": "Days Recorded" },
        "habitsData": { "title": "Habits", "details": "Habits Details", "completionRate": "Completion Rate", "completed": "Habits Completed" },
        "recommendationsList": {
          "start": { "title": "Start Recording Your Data", "advice": "The more data you record, the more accurate recommendations you get", "action": "Record your first health reading today" },
          "sleepMore": { "title": "Improve Your Sleep", "advice": "You sleep an average of {{hours}} hours only", "action": "Try to sleep 7-8 hours daily to improve your health" },
          "increaseCalories": { "title": "Increase Your Calories", "advice": "You only consume {{calories}} calories per day", "action": "Add healthy protein-rich meals" },
          "decreaseCalories": { "title": "Reduce Your Calories", "advice": "You consume {{calories}} calories per day", "action": "Focus on vegetables and protein, reduce carbohydrates" },
          "increaseActivity": { "title": "Increase Your Activity", "advice": "You only exercise {{minutes}} minutes daily", "action": "Walking 30 minutes daily significantly improves your health" },
          "improveMood": { "title": "Improve Your Mood", "advice": "Your average mood is {{mood}}/5", "action": "Try meditation or deep breathing exercises" },
          "improveHabits": { "title": "Commit to Your Habits", "advice": "You only commit to your habits by {{rate}}%", "action": "Start with a small, easy-to-apply habit" },
          "excellent": { "title": "Well done!", "advice": "All your health indicators are good", "action": "Continue this great healthy pattern" }
        }
      },
      "register": {
