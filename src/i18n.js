  ...
  "lastUpdateFormatted": "🕒 {{time}}",
      ...
      "profile": {
        ...
        "goals": {
          ...
          "startAdding": "ابدأ بإضافة هدفك الصحي الأول",
          "deleteConfirm": "هل أنت متأكد من حذف هذا الهدف؟",
          "progressUpdated": "✅ تم تحديث التقدم",
          "added": "✅ تم إضافة الهدف بنجاح",
          "deleted": "✅ تم حذف الهدف",
...
// src/i18n.js - الجزء المكمل (الإضافة إلى الملف الرئيسي)

// أضف هذه الأقسام داخل كائن "resources" في قسم "ar" -> "translation"
...
// src/i18n.js - English Translation (Part 1)
// Add this entire object to the "en" -> "translation" section
...
// src/i18n.js - English Translation (Complete)
// Add this entire object to the "en" -> "translation" section
