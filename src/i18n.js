  ...
  "notifications": {
    ...
    "stats": {
      ...
      "reports": {
        ...
        "records": "عدد التسجيلات",
        "quarterly": "ربع سنوي",
        "sleep": { "title": "النوم", "details": "تفاصيل النوم", "avgHours": "متوسط ساعات النوم", "totalNights": "عدد الليالي المسجلة", "hours": "ساعات" },
        "nutrition": { "title": "التغذية", "details": "تفاصيل التغذية", "avgCalories": "متوسط السعرات اليومية", "avgProtein": "متوسط البروتين", "totalMeals": "إجمالي الوجبات" },
        "activity": { "title": "النشاط البدني", "details": "تفاصيل النشاط", "totalMinutes": "إجمالي دقائق النشاط", "avgMinutes": "متوسط النشاط اليومي", "records": "عدد الأنشطة", "minutes": "دقيقة", "perDay": "في اليوم" },
        "mood": { "title": "المزاج", "details": "تفاصيل المزاج", "avgScore": "متوسط درجة المزاج", "totalDays": "عدد الأيام المسجلة" },
        "habits": { "title": "العادات", "details": "تفاصيل العادات", "completionRate": "نسبة الالتزام", "completed": "العادات المنجزة" },
        "recommendations": {
...
"en": {
  ...
  "notifications": {
    ...
    "reports": {
      ...
      "records": "Records",
      "quarterly": "Quarterly",
      "sleep": { "title": "Sleep", "details": "Sleep Details", "avgHours": "Average Sleep Hours", "totalNights": "Nights Recorded", "hours": "hours" },
      "nutrition": { "title": "Nutrition", "details": "Nutrition Details", "avgCalories": "Average Daily Calories", "avgProtein": "Average Protein", "totalMeals": "Total Meals" },
      "activity": { "title": "Physical Activity", "details": "Activity Details", "totalMinutes": "Total Activity Minutes", "avgMinutes": "Average Daily Activity", "records": "Activities Count", "minutes": "minutes", "perDay": "per day" },
      "mood": { "title": "Mood", "details": "Mood Details", "avgScore": "Average Mood Score", "totalDays": "Days Recorded" },
      "habits": { "title": "Habits", "details": "Habits Details", "completionRate": "Completion Rate", "completed": "Habits Completed" },
      "recommendations": {
