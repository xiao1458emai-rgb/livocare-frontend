    ...
    const fetchAllData = async () => {
        ...
        try {
            ...
            if (weatherRes.data?.success) {
                setWeather(weatherRes.data.data || weatherRes.data);
            } else if (weatherRes.data && !weatherRes.data.success) {
                setWeather(null);
            }
    ...
    return (
        <div className={`smart-recommendations ${darkMode ? 'dark-mode' : ''}`}>
                    ...
                    {weather && (
                        <div className="weather-card">
                            ...
                            <div className="weather-info">
                                ...
                                {weather.condition && <div className="weather-condition">{weather.condition}</div>}
                            </div>
                        </div>
                    )}
                </div>
            ...
            <style jsx>{`
                ...
                .weather-card { background: linear-gradient(135deg, #3b82f6, #8b5cf6); border-radius: 20px; padding: 1rem; color: white; margin-bottom: 1.5rem; }
